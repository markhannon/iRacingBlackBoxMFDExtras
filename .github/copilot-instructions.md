...
## UI helpers
- Shared drawing helpers live in lib/ui.lua, while shared telemetry and driver helpers live in lib/data.lua.
...
- Use the shared connected-driver helpers in lib/data.lua instead of relying on raw SIM.carsCount alone.
